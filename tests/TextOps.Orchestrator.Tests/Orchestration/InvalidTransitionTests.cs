...
public class InvalidTransitionTests : OrchestratorTestBase
{
    ...
    [Test]
    public async Task HandleInbound_ApproveTwice_SecondIsRejected()
    {
        ...
        await Orchestrator.HandleInboundAsync(approveMsg1, approveIntent1);
        ...
        var result2 = await Orchestrator.HandleInboundAsync(approveMsg2, approveIntent2);
    ...
    [Test]
    public async Task HandleInbound_DenyAfterApprove_Rejected()
    {
        // Arrange: Approve the run first
        ...
        var result = await Orchestrator.HandleInboundAsync(denyMsg, denyIntent);
    ...
    [Test]
    public async Task HandleInbound_ApproveUnknownRun_Rejected()
    {
        // Arrange
    ...
    [Test]
    public async Task HandleInbound_DenyAfterDeny_Rejected()
    {
        ...
        await Orchestrator.HandleInboundAsync(denyMsg1, denyIntent1);
        ...
        var result = await Orchestrator.HandleInboundAsync(denyMsg2, denyIntent2);
